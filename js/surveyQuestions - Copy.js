	...
	.done(function( data ) {
		...
		for (var i = 0; i < questions.length; i += 2) {
			...
			if (i == 0) {
				...
				var str1 = "<div class='Sprint-Slides' style='display:block'><h4>Today</h4><h5>" + questions[i].question + "</h5><div class='row'><span name='questionInfo' style='display:none'>" + todayQuestionInfo + "</span><div class='btn-group btn-group-lg btn-vertical col-12 answersSquares' data-toggle='buttons'>";
				...
				var str8 = "<h4 class='futureSpace'>Future</h4><h5>" + questions[j].question + "</h5><div class='row'><span name='questionInfo' style='display:none'>" + futureQuestionInfo + "</span><div class='btn-group btn-group-lg btn-vertical col-12 answersSquares' data-toggle='buttons'>";			
				...
				var todayQuestionInfo = questions[i].questionId + "|" + questions[i].time + "|" + questions[i].trend + "|" + questions[i].impactToScore + "|" + questions[i].questionType;
				var futureQuestionInfo = questions[j].questionId + "|" + questions[j].time + "|" + questions[j].trend + "|" + questions[j].impactToScore + "|" + questions[j].questionType;
				var str1 = "<div class='Sprint-Slides'><h4>Today</h4><h5>" + questions[i].question + "</h5><div class='row'><span name='questionInfo' style='display:none'>" + todayQuestionInfo + "</span><div class='btn-group btn-group-lg btn-vertical col-12 answersSquares' data-toggle='buttons'>";
